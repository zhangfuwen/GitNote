...
| task     | speed(s/it) | num_gpu | batch size per gpu | gradient_accumulation_steps | cutoff_len | gpu memory usage(GB) | memory bandwidth |
| -------- | ----------- | ------- | ------------------ | --------------------------- | ---------- | -------------------- | ---------------- |
| pretrain | 0.3         | 1       | 8                  | 1                           | 1024       | 20.13                | 70%              |
|          |             |         |                    |                             |            |                      |                  |
|          |             |         |                    |                             |            |                      |                  |
