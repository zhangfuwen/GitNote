...
| task     | fp16 | speed(it/s) | num_gpu | batch size per gpu | gradient_accumulation_steps | cutoff_len | gpu memory usage(GB) | memory bandwidth |
| -------- | ---- | ----------- | ------- | ------------------ | --------------------------- | ---------- | -------------------- | ---------------- |
| pretrain | true | 3.3         | 1       | 8                  | 1                           | 1024       | 18.8                 | 70%              |
| pretrain | true | 12.3        | 1       | 1                  | 1                           | 1024       | 4.5                  |                  |
|          |      |             |         |                    |                             |            |                      |                  |
