...
## EGL/GLES extensions on Adreno 650
...
```c
GLES: Qualcomm, Adreno (TM) 650, OpenGL ES 3.2 V@0607.0 (GIT@59c88eaa85, I0e5d7f66c4, 1635490226) (Date:10/28/21)
GL_AMD_compressed_ATC_texture
GL_ANDROID_extension_pack_es31a
GL_ARM_shader_framebuffer_fetch_depth_stencil
GL_EXT_EGL_image_array
