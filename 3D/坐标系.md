...
投影，正交投影（orthogonal [ɔ:ˈθɔɡənl] projection），透视投影（perspective [pəˈspektiv] projection)
环境光（ambient light [ˈæmbi:ənt lait]），镜面光（specular ['spekjʊlə]），漫反射（diffuse [dɪˈfjuːs , dɪˈfjuːz]）
